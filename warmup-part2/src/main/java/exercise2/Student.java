...
public class Student {
    ...
    public String toString() {
        return "Id" + this.getId() + "First name: " + this.getFirstName() + "Last Name: " + this.getLastName() + "Grade: " + this.getAverageGrade();
    }
    ...
    public boolean equals(Object o) {
        ...
        if(this.firstName.equals(student.getFirstName()) && this.lastName.equals(student.getLastName()) && this.id.equals(student.getId()) && this.averageGrade.equals(student.getAverageGrade()))
            return true;
    ...
    @Override
    public int hashCode() {
        return (31 * this.id + this.lastName.hashCode() + this.firstName.hashCode() + this.averageGrade.hashCode());
