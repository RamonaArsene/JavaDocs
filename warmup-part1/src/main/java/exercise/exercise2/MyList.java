 ...
 *
 *             Finally, you wi1ll need to override the clear method and create a getter method for the
...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean addAll(Collection<? extends Integer> elemList){

        for(Integer it:elemList) {
            if (!super.contains(it)) {
                this.differentElements++;
            }
        }
        return super.addAll(elemList);
    }
    ...
    public boolean addAll(int index, Collection<? extends Integer> elemList){
        ...
        return super.addAll(index, elemList);
    }
    ...
    public boolean remove(Object elem){
        boolean success = super.remove(elem);
        if(!super.contains(elem)){
            differentElements --;
        }
